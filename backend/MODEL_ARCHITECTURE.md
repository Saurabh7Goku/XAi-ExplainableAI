...
> **Note**: This project primarily demonstrates **Explainable AI (XAI)** methodologies in agricultural image classification. While the Vision Transformer model achieves strong performance metrics, the central goal is to showcase **transparent AI reasoning** — illustrating how the model analyzes visual features and arrives at predictions through attention mechanisms and LIME-based explanations.
