...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 bg-grid-pattern">
      ...
      <div
        className="fixed top-20 left-10 text-6xl opacity-10 animate-float pointer-events-none"
        style={{ animationDelay: "0s" }}
      >
        🥭
      </div>
      <div
        className="fixed top-40 right-16 text-5xl opacity-10 animate-float pointer-events-none"
        style={{ animationDelay: "1s" }}
      >
        🍃
      </div>
      <div
        className="fixed bottom-40 left-20 text-6xl opacity-10 animate-float pointer-events-none"
        style={{ animationDelay: "2s" }}
      >
        🌿
      </div>
      <div
        className="fixed bottom-20 right-10 text-5xl opacity-10 animate-float pointer-events-none"
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-2 py-10 md:py-28 text-center">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6 leading-tight">
            ...
            <span
              className="inline-block bg-gradient-to-r from-yellow-300 to-orange-300 bg-clip-text text-transparent animate-fade-in-up"
          ...
          <p
            className="text-xl md:text-2xl text-green-100 max-w-4xl mx-auto mb-12 animate-fade-in-up"
            style={{ animationDelay: "0.4s" }}
          >
            Advanced AI-powered analysis for mango leaf health using{" "}
            <strong className="text-white">Vision Transformers</strong> and{" "}
            <strong className="text-white">Explainable AI</strong>
          </p>
          <p
            className="text-base text-green-200/80 max-w-3xl mx-auto animate-fade-in-up"
            style={{ animationDelay: "0.5s" }}
          >
            <span className="font-medium text-green-100">Focus:</span>{" "}
            Demonstrating transparent AI reasoning — visualizing which leaf
            features drive each prediction
          </p>

          {/* Feature Cards */}
          <div
            className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16 animate-fade-in-up"
            style={{ animationDelay: "0.5s" }}
          >
            {[
              {
                icon: "🧠",
                title: "Deep Learning",
                desc: "ViT-based neural network trained on 10,000+ mango leaf images",
              },
              {
                icon: "🔍",
                title: "XAI Transparency",
                desc: "Attention rollout shows exactly which leaf regions triggered the diagnosis",
              },
              {
                icon: "📋",
                title: "Smart Reports",
                desc: "Get detailed actionable recommendations for disease management",
              },
            ].map((feature, i) => (
              <div
                key={i}
                className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/15 transition-all hover:scale-105"
              >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 animate-fade-in-up">
            ...
            <p className="text-gray-600 text-lg max-w-3xl mx-auto">
              Upload a clear photo of the mango leaf you want to analyze, or
              click any sample image below to instantly test the AI.
            </p>
          </div>
              ...
              <div className="bg-white rounded-3xl shadow-xl shadow-green-200/30 p-6 md:p-8 border border-green-100">
                <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
                  <div>
                    ...
                    <p className="text-xs text-gray-400 mt-1">
                      Click any image to test the AI — all 8 disease categories
                      covered
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                  {[
                    ...
                    {
                      src: "/samples/Bacterial-Canker-1.jpg",
                      cat: "Bacterial Canker",
                    },
                    {
                      src: "/samples/Bacterial-Canker-2.jpg",
                      cat: "Bacterial Canker",
                    },
                    {
                      src: "/samples/Bacterial-Canker-3.jpg",
                      cat: "Bacterial Canker",
                    },
                    {
                      src: "/samples/Cutting-Weevil-1.jpg",
                      cat: "Cutting Weevil",
                    },
                    {
                      src: "/samples/Cutting-Weevil-2.jpg",
                      cat: "Cutting Weevil",
                    },
                    {
                      src: "/samples/Cutting-Weevil-3.jpg",
                      cat: "Cutting Weevil",
                    },
                    ...
                    {
                      src: "/samples/Powdery-Mildew-1.jpg",
                      cat: "Powdery Mildew",
                    },
                    {
                      src: "/samples/Powdery-Mildew-2.jpg",
                      cat: "Powdery Mildew",
                    },
                    {
                      src: "/samples/Powdery-Mildew-3.jpg",
                      cat: "Powdery Mildew",
                    },
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="absolute top-1.5 right-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                          <span className="px-2 py-0.5 bg-green-500 text-white text-[10px] rounded-full font-bold shadow-lg">
                            ▶ Test
                          </span>
                        </div>
                      </button>
              ...
              <div className="bg-white rounded-3xl shadow-xl shadow-green-200/30 p-6 md:p-8 border border-green-100 relative overflow-hidden sticky top-24">
                ...
                <div className="relative z-10">
                  <div className="text-center mb-6">
                    ...
                    <p className="text-xs text-gray-400 mt-1">
                      or drag & drop your own leaf photo
                    </p>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-blue-800 text-sm leading-relaxed mb-2">
                      ...
                      <strong>Explainable AI (XAI)</strong> capabilities — the
                      primary goal is to illuminate{" "}
                      <strong>how the model reasons</strong> and{" "}
                      <strong>which visual features drive the diagnosis</strong>
                      , not just to provide a classification label.
                    </p>
                    <p className="text-blue-700 text-xs leading-relaxed">
                      The Vision Transformer model analyzes attention patterns
                      to create transparent explanations. While the model is
                      trained on extensive agricultural data, clinical
                      verification by agricultural experts is recommended for
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                ...
                <div className="space-y-8 animate-slide-in-right">
                  ...
                  {prediction.class_probabilities &&
                    Object.keys(prediction.class_probabilities).length > 0 && (
                              ...
                              return (
                                <div key={disease} className="group">
                                  <div className="flex justify-between text-sm mb-1">
                                    <span
                                      className={`${isTop ? "font-bold text-gray-900" : "text-gray-600"}`}
                                    >
                                      {disease}
                                      {isTop && (
                                    ...
                                    <span
                                      className={`${isTop ? "font-bold text-green-700" : "text-gray-500"}`}
                                    >
                                      {barWidth.toFixed(1)}%
                                    </span>
                                  </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <ul className="text-sm text-gray-700 space-y-1.5">
                          {prediction.disease_info.symptoms
                            ?.slice(0, 4)
                      ...
                      <div className="border-t border-green-100 pt-4">
                        ...
                        <ul className="text-sm text-gray-700 space-y-1.5">
                          {prediction.disease_info.treatments
                            ?.slice(0, 3)
                            .map((treatment: string, idx: number) => (
                              <li key={idx} className="flex items-start gap-2">
                  ...
                  <div className="relative overflow-hidden">
                    <div className="bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 px-8 py-8 relative">
                      ...
                      <p className="text-green-200 mt-2 text-sm relative z-10">
                        AI-Generated comprehensive diagnosis with treatment
                        recommendations
                      </p>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="text-center group">
                <div
                  className={`w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br ${stat.color} flex items-center justify-center text-2xl group-hover:scale-110 transition-transform shadow-lg`}
                >
                  {stat.icon}
                </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 max-w-md leading-relaxed">
                Empowering farmers with cutting-edge AI technology for early
                disease detection in mango crops. Our Vision Transformer model
                provides fast, accurate, and explainable diagnoses.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-gray-400">
                ...
                <li className="flex items-center gap-2">
                  <span className="w-1 h-1 rounded-full bg-green-500"></span>XAI
                  Attention Rollout
                </li>
                <li className="flex items-center gap-2">
                  <span className="w-1 h-1 rounded-full bg-green-500"></span>
          ...
          <div className="border-t border-gray-700/50 mt-10 pt-8 text-center">
            <p className="text-gray-500 text-sm">
              Built with ❤️ for farmers worldwide • Powered by Explainable AI
              Technology
            </p>
          </div>
        </div>
